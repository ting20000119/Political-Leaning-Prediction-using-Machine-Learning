...
def main():
    features = preprocessing.getfeaturesmax() #can change to getfeaturesuser for different normalization technique 
    print(features)
    ####start learning
    ...
    # Get numerical feature importances
        findimportance(rf,feature_list)

    dbconnect.disconnect()

def findimportance(rf,feature_list):
# Get numerical feature importances
